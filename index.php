...
// This is the main page of the project. It contains the products that we want to sell. Each product has a "Pay Now" button that will redirect the user to the payment page.
// connect to the database and fetch the products from the "products" table. Then, we will display the products in a card format using Bootstrap. 
// We will also include a footer at the bottom of the page.
  ...
  <div class="container">
    <div class="row mt-5">
      ...
      <div class="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
        <div class="card">
          <img height="213px" class="card-img-top" src="images/<?= $product->image ?>">
          <div class="card-body">
            <h5 class="d-inline"><b><?= $product->title ?></b> </h5>
            <h5 class="d-inline">
